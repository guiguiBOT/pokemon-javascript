...
// Déclaration de la fonction pour annoncer les attaques disponibles
...
//  Déclaration de la fonction pour récupérer le choix d'attaque du joueur dans la variable attackChoiceUser
...
// Déclaration de la fonction pour attaquer
...
// Décalaration des attaques dans des objets
const attackOne = {
    name: "1 : FastAttack",
    power: 10,
    accuracy: 2
...
// Déclaration du tableau contenant les objets attaques
const tableauAttack = [attackOne, attackTwo, attackThree, attackFour];

// Déclaration tableaux de chaque joueur
let guerrierDuFeu = {
...
// Déclaration tableau des deux joueurs pour tirage au sort début de partie
let bothPlayers = [guerrierDuFeu, sombreLutin];

// création fonction pour tirage au sort de début de partie
function tirageAuSort(max) {
    return Math.floor(Math.random() * max)
}

// Attribution des valeurs contenues dans le tableau des personnages dans des variables
let firstPlayer = bothPlayers[0];
let secondPlayer = bothPlayers[1];


// Annnonce du début de partie avec le nom du perso
console.log("------------------------------------------------------------");
console.log("Vous êtes " + firstPlayer.name + " vous démarrez la partie !");
console.log("        L'ordinateur joue " + secondPlayer.name);
console.log("------------------------------------------------------------");
console.log("");

while (firstPlayer.pv > 0 && secondPlayer.pv > 0) {
    
// Annonce des différentes attaques
annonceAttack();

// récupération du choix d'attaque de l'utilisateur
